	...
	private MenuBar() {
			...
			close.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int code= JOptionPane.showOptionDialog(Frame.getInstance().getContentPane(), "Da li ste sigurni da želite da zatvorite aplikaciju?", "Zatvaranje aplikacije", 0, JOptionPane.INFORMATION_MESSAGE, null, options, null);
